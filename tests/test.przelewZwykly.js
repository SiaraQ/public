...
it('Dodanie przelewu zwyklego', function() {
    ...
    payments.tworzPrzelewZwykly(loginDane.rachunekNadawcy,loginDane.nazwaOdbiorcy,loginDane.rachunekOdbiorcy,loginDane.tytulPrzelewu,loginDane.kwota,loginDane.dataRealizacji,loginDane.hasloSms,false);
});
